...
export const TreasurySchema = z.object({
	...
	metadata: z.object({
		...
		chainData: z.record(z.number(), z.object({
			nonce: z.number().optional(),
			version: z.string().optional(),
			masterCopy: z.string().optional(),
		})).optional(),
	}).nullable(),
	isActive: z.boolean(),
...
export const CreateTreasurySchema = z.object({
	...
	chainIds: z.array(z.number()).default([1]).describe("Blockchain network IDs"),
...
export const AddProjectTreasurySchema = z.object({
	...
	chainIds: z.array(z.number()).default([1]).optional().describe("Blockchain network IDs"),
